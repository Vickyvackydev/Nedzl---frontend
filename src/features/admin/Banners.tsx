    ...
    <DashboardLayout>
      <div className="p-3 sm:p-5 geist-family w-full flex flex-col items-start gap-y-5">
            ...
            <div className="flex flex-col w-full lg:w-1/3 gap-y-1">
              <span className="text-sm font-medium text-[#4F5762]">
                ...
                <span className="text-xs text-gray-500 font-normal">
                  (Recommended: 1200/1500/1900 × 400px, 3:1 ratio)
                </span>
              </span>
              ...
              <div className="flex items-center gap-2">
                ...
                {urlType === "section" && (
                  ...
                  >
                    ...
                    <option value="/products?section=todays-deal">
                      Today's Deal
                    </option>
                ...
                {urlType === "category" && (
                  ...
                  >
                    ...
                    <option value="/products?category=electricals">
                      Electricals
                    </option>
                    <option value="/products?category=home-appliances">
                      Home Appliances
                    </option>
                    <option value="/products?category=furniture">
                      Furniture
                    </option>
                    <option value="/products?category=kitchenware">
                      Kitchenware
                    </option>
        ...
        <div className="w-full bg-white rounded-xl p-5 border border-borderColor">
          <h2 className="text-lg font-medium text-primary-300 mb-4">
            Existing Banners
          </h2>
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {banners?.data?.map((banner: Banner) => (
                <div
                  key={banner.id}
                  className="border border-borderColor rounded-xl overflow-hidden flex flex-col"
                >
                  ...
                  <div className="p-3 flex flex-col gap-y-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-sm text-global-green underline truncate"
                    >
                      {banner.target_url}
                    </a>
