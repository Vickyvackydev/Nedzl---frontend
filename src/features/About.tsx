  ...
  return (
    <MainLayout>
      ...
      <div className="w-full h-full px-4 md:px-20 py-10 overflow-x-hidden">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5 mt-16 md:mt-24 mb-10">
          <motion.div
          ...
          <motion.div
            ...
            className="w-full rounded-2xl bg-[#F0F5FF] p-6 md:p-8 flex flex-col gap-y-4"
          >
            <div className="bg-white/50 w-fit p-2.5 rounded-xl">
              <Users className="w-5 h-5 text-[#2563EB]" />
            </div>
            <span className="text-[#303237] text-xl font-bold">Our Team</span>
            <p className="text-[#565C69] font-medium text-sm md:text-[16px] leading-relaxed">
              Our team of 7 is dedicated to powering the campus marketplace—ensuring student-verified safety, supporting buyers and sellers across Nigerian universities, and making trading textbooks, gadgets, and everyday school essentials simple, secure, and affordable.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            ...
            className="w-full rounded-2xl bg-[#FFF9EB] p-6 md:p-8 flex flex-col gap-y-4"
          >
            <div className="bg-white/50 w-fit p-2.5 rounded-xl">
            ...
            <p className="text-[#565C69] font-medium text-sm md:text-[16px] leading-relaxed">
              Our 5 board members provide strategic direction, campus partnerships, and governance to expand Nedzl across tertiary institutions nationwide, ensuring high trust standards and sustainable value for the student community.
            </p>
          </motion.div>
        </div>
      </div>
