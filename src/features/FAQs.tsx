    ...
    >
      ...
      {isOpen && (
        <div className="px-6 md:px-8 pb-8 animate-fadeIn">
          <p className="text-[15px] md:text-[16px] leading-[1.7] text-[#555555]">{answer}</p>
        </div>
      )}
    </div>
  );
...
const FAQs = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Yes, as long as they’re appropriate for the student audience and meet our terms of service.',
    },
    {
    ...
    },
    {
      ...
      answer: 'We welcome feedback! Use the contact/support page or email our team directly to share your suggestions.',
    },
  ];
  ...
  return (
    <MainLayout>
      <SEO
        title="FAQs"
        description="Answers to common questions about using Nedzl.com as a buyer or seller."
        structuredData={{
      ...
      <div className="w-full font-open-sans bg-white pb-20">
        <div className="w-full flex flex-col gap-y-1 bg-[#F2FEF0] h-[300px] items-center justify-center mb-16">
          ...
          <p className="text-[#555555] text-center text-[15px] md:text-[16px] font-medium max-w-[600px] px-4">
            Find answers to common questions about using Nedzl.com as a buyer or seller.
          </p>
        </div>
